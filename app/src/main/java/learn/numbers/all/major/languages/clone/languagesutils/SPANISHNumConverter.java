    ...
    public  String convertNumber(long number) {
        ...
        switch (billions) {
            case 0:
                ...
                break;
            case 1 :
                tradBillions = convertLessThanThousand(billions) + "mil millones ";
                break;
            default :
                tradBillions = convertLessThanThousand(billions) + " millónes ";
        }
        ...
        switch (millions) {
            case 0:
                ...
                break;
            case 1 :
                tradMillions = convertLessThanThousand(millions) + " un millón ";
                break;
            default :
                tradMillions = convertLessThanThousand(millions) + " millón ";
        }
