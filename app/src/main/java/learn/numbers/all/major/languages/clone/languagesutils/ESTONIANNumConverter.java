...
public class ESTONIANNumConverter implements Language {

    public String[] sNum = new String[]{"null","sada","tuhat","miljon","miljard","triljon"};
    public final String[] tensNames = {
            "", " ten", " kakskümmend", " kolmkümmend", " nelikümmend", " viiskümmend",
            " kuuskümmend", " seitsekümmend", " kaheksakümmend", " uheksakümmend"
    };
    ...
    public final String[] numNames = {
            ...
            " üheksa", " kümme", " üksteist", " kaksteist", " kolmteist", " neliteist",
            " viisteist", " kuusteist", " seitseteist", " kaheksateist", " üheksateist"
    };
    public ESTONIANNumConverter() {}
    ...
    public  String convertNumber(long number) {
        ...
        if (millions == 0) {
            ...
            tradMillions = convertLessThanThousand(millions) + " miljon ";
        }
        ...
        switch (hundredThousands) {
            case 0:
                ...
                break;
            case 1 :
                tradHundredThousands = "uks tuhat ";
                break;
            default :
