...
public class LUXEMBOURGISHNumConverter implements Language {

    public String[] sNum = new String[]{"Null","honnert","dausend","millioun","milliard","billion"};
    public final String[] tensNames = {
            "", " ten", " zwanzeg", " drësseg", " véierzeg", " fofzeg", " sechzeg", " siwwenzeg",
            " achtzeg", " nonzeg"
    };
    ...
    public final String[] numNames = {
            "",
            " eent", " zwee", " dräi", " véier", " fënnef", " sechs", " siwen", " aacht",
            " néng", " zéng", " eelef", " zwielef", " dräizéng", " véierzéng", " fofzéng",
            " siechzéng", " siwwenzéng", " uechtzéng", " nonzéng"
    };
    public LUXEMBOURGISHNumConverter() {}
    ...
    public String convertLessThanThousand(int number) {
        ...
        return numNames[number] + " honnert" + soFar;
    }
    ...
    public  String convertNumber(long number) {
        ...
        if (millions == 0) {
            ...
            tradMillions = convertLessThanThousand(millions) + " millioun ";
        }
        ...
        switch (hundredThousands) {
            case 0:
                ...
                break;
            case 1 :
                tradHundredThousands = "eent dausend ";
                break;
            default :
                tradHundredThousands = convertLessThanThousand(hundredThousands) + " dausend ";
        }
